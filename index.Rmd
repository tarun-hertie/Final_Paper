...
```{r, include=F, message=F, warning=FALSE, error=FALSE, echo=FALSE, type = 'html', results='asis', fig.height=4, cache=TRUE}
...
```{r, include=T, message=F, warning=FALSE, error=FALSE, echo=FALSE, type = 'html', results='asis', fig.height=10, cache=TRUE}

re_data1$year <- as.numeric(re_data1$year)

M = gvisMotionChart(data=re_data1, idvar="country", timevar="year", chartid="re_all_var")
print(M,  tag = 'chart')
