...
### What are the renewable energy penetration levels across EU countries? 

```{r, include=T, message=F, warning=FALSE, error=FALSE, echo=FALSE, type = 'html', results='asis', fig.height=6}
