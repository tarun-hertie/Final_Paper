...
Our analysis of the determinants of renewable energy in EU countries using panel data and a fixed effect models reveals that cost of alternate energy is the single most important variable in hastening a shift towards wind and solar energy generation. We also find a surprising statistically significant negative relationship between renewable energy development and per capita income in European countries. The effect was consistent across model specifications and needs to be investigated further. On the other hand some model specifications confirm findings in the literature that technology development provides an important impetus for shift towards renewables. We also find statistically significant country fixed effects which in-part captures favourable policy incentives for renewable energy development. 
